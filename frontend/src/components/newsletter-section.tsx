            ...
            <BlurPanel className="p-8 lg:p-12 bg-white/40 backdrop-blur-md grain-texture">
              <div className="text-center mb-8">
                <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 mb-4">
                  <AnimatedText text="Book your " delay={0.2} />
                  <span className="italic font-light">
                    <AnimatedText text="appointment today." delay={0.5} />
                  </span>
                </h2>
                <p className="text-lg text-neutral-600">
                  Subscribe to get exclusive offers, styling tips, and early access to new services.
                </p>
              </div>
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-neutral-900 mb-2">Welcome to LUXE Hair Studio</h3>
                  <p className="text-neutral-600">
                    Thank you for subscribing. You'll receive exclusive offers and styling tips.
                  </p>
                </motion.div>
              )}
